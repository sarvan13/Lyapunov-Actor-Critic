...
# x = np.load('/home/sarvan/Classes/Lyapunov-Actor-Critic/data/pendulum/arrays/lac-step2-arr.npy')
# y = np.load('/home/sarvan/Classes/Lyapunov-Actor-Critic/data/pendulum/arrays/lac-cost2-arr.npy')
# x = x/1000
# lac_mean_rewards = [np.mean(y[np.max((0,i - 50)): i]) for i in range(len(y))]

x1 = np.load('C:\\Users\\Sarvan\\Desktop\\School\\UVIC\\Lyapunov-Actor-Critic\\data\\pendulum\\arrays\\sac-pendulum-step2-arr.npy')
y1 = np.load('C:\\Users\\Sarvan\\Desktop\\School\\UVIC\\Lyapunov-Actor-Critic\\data\\pendulum\\arrays\\sac-pendulum-cost2-arr.npy')
...
# lambda_arr = np.load('/home/sarvan/Classes/Lyapunov-Actor-Critic/data/pendulum/arrays/lac-lambda2-arr.npy')
# lambda_mean_arr = [np.mean(lambda_arr[np.max((0,i - 50)): i]) for i in range(len(lambda_arr))]
# beta_arr = np.load('/home/sarvan/Classes/Lyapunov-Actor-Critic/data/pendulum/arrays/lac-beta2-arr.npy')
