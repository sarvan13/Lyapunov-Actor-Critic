...
x = np.load('/home/sarvan/Classes/Lyapunov-Actor-Critic/data/half_cheetah/arrays/lac-step-arr.npy')
y = np.load('/home/sarvan/Classes/Lyapunov-Actor-Critic/data/half_cheetah/arrays/lac-cost-arr.npy')
x = x/1000
lac_mean_rewards = [np.mean(y[np.max((0,i - 50)): i]) for i in range(len(y))]

# x1 = np.load('/home/sarvan/Classes/Lyapunov-Actor-Critic/sac-3cost-step-arr.npy')
# y1 = np.load('/home/sarvan/Classes/Lyapunov-Actor-Critic/sac-3cost-arr.npy')
# x1 = x1/1000
...
lambda_arr = np.load('/home/sarvan/Classes/Lyapunov-Actor-Critic/data/half_cheetah/arrays/lac-lambda-arr.npy')
lambda_mean_arr = [np.mean(lambda_arr[np.max((0,i - 50)): i]) for i in range(len(lambda_arr))]
beta_arr = np.load('/home/sarvan/Classes/Lyapunov-Actor-Critic/data/half_cheetah/arrays/lac-beta-arr.npy')
