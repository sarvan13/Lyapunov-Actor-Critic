...
lambda_arr = np.load('/home/sarvan/Classes/Lyapunov-Actor-Critic/lac-lambda-arr.npy')
lambda_mean_arr = [np.mean(lambda_arr[np.max((0,i - 50)): i]) for i in range(len(lambda_arr))]
beta_arr = np.load('/home/sarvan/Classes/Lyapunov-Actor-Critic/lac-beta-arr.npy')
