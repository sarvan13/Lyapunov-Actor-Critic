...
class ActorNet(nn.Module):
    def __init__(self, state_dims, action_dims, max_action, lr=1e-4, fc1_dims=256, fc2_dims=256, 
                 reparam_noise=1e-6, name='LACActor2.pth', save_dir='data/cartpole/models'):
...
class LyapunovCriticNet(nn.Module):
    def __init__(self, state_dims, action_dims, lr=3e-4, fc1_dims=64, fc2_dims=64, name='Lc2.pth', save_dir='data/cartpole/models'):
